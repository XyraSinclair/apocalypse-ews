...
const REQUIRED_SECRET_KEYS = REQUIRED_DEPLOY_ENV_VARS.filter(
  (key) =>
    !Object.hasOwn(PRODUCTION_VARIABLES, key) &&
    !ACCESS_CLIENT_ID_SECRETS.includes(key) &&
    !ACCESS_CLIENT_SECRET_SECRETS.includes(key),
);
